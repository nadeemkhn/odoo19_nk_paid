...
class DeliveryCarrier(models.Model):
    ...
    def create(self, vals_list):
        ...
        for vals in vals_list:
            if vals.get('delivery_type') == 'leopards':
                ...
                if 'allow_cash_on_delivery' not in vals:
    ...
    def leopards_rate_shipment(self, order):
        ...
        try:
            ...
            cod_amount = order.amount_total if (self.allow_cash_on_delivery and order.amount_total) else 0
            ...
            try:
                ...
                if shipment_response and shipment_response.get('success'):
                    ...
                    if actual_price is None or actual_price == 0:
                        ...
                        cod = int(picking.sale_id.amount_total or 0) if (picking.sale_id and self.allow_cash_on_delivery) else 0
                        rate_result = self._leopards_get_rate(
                            weight=weight_kg,
